...
class AdaBoost:
    ...
    def fit(self, X, y, M,K,learning_rate):
        ...
        for m in range(0, M):
            ...
            # (b) Compute error
            error_m = self.compute_error(y_s, y_pred, w_i)
            ...
            # (d) Update w_i
            w_i = self.update_weights(w_i, alpha_m, y_s, y_pred)  
...
X_train, X_test, y_train, y_test = load_data('abalone', test_size=0.2, random_state=0)
